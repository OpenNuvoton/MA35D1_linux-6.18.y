...
enum ma35_format_enum {
	MA35_FORMAT_X4R4G4B4      = 0,	// DRM_FORMAT_XRGB4444
	MA35_FORMAT_A4R4G4B4      = 1,	// DRM_FORMAT_ARGB4444
	MA35_FORMAT_X1R5G5B5      = 2,	// DRM_FORMAT_XRGB1555
	MA35_FORMAT_A1R5G5B5      = 3,	// DRM_FORMAT_ARGB1555
	MA35_FORMAT_R5G6B5        = 4,	// DRM_FORMAT_RGB565
	MA35_FORMAT_X8R8G8B8      = 5,	// DRM_FORMAT_XRGB8888
	MA35_FORMAT_A8R8G8B8      = 6,	// DRM_FORMAT_ARGB8888
	MA35_FORMAT_YUY2          = 7,	// YUV422, DRM_FORMAT_YUYV
	MA35_FORMAT_UYVY          = 8,	// YUV422, DRM_FORMAT_UYVY
	MA35_FORMAT_INDEX8        = 9,
	MA35_FORMAT_MONOCHROME    = 10,
	MA35_FORMAT_YV12          = 15,	// YUV420, DRM_FORMAT_YVU420
	MA35_FORMAT_A8            = 16,
	MA35_FORMAT_NV12          = 17,	// YUV420, DRM_FORMAT_NV12
	MA35_FORMAT_NV16          = 18,	// YUV422, DRM_FORMAT_NV16
	MA35_FORMAT_RG16          = 19,
	MA35_FORMAT_R8            = 20,
	MA35_FORMAT_NV12_10BIT    = 21,
	MA35_FORMAT_A2R10G10B10   = 22,	// DRM_FORMAT_ARGB2101010
	MA35_FORMAT_NV16_10BIT    = 23,
	MA35_FORMAT_INDEX1        = 24,
	MA35_FORMAT_INDEX2        = 25,
	MA35_FORMAT_INDEX4        = 26,
	MA35_FORMAT_P010          = 27,	// YUV420, DRM_FORMAT_P010
	MA35_FORMAT_NV12_10BIT_L1 = 28,
	MA35_FORMAT_NV16_10BIT_L1 = 29,
};
