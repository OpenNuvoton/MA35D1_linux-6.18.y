...
/*
 * Nuvoton MA35D1 Clock PLL driver
 *
...
static unsigned long ma35d1_pll_frac_mode_find_closest(struct ma35d1_clk_pll *pll,
			     ...
			     unsigned long u64PllFreq)
{
	...
	case VSIPLL_SS_MODE:
		u64PllClk = ma35d1_pll_frac_mode_find_closest(pll, u64PllFreq,
							      PllSrcClk, u32Reg,
							      &u64PllClk);
		val_ctl0 = u32Reg[0];
		break;
